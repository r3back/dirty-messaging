package com.qualityplus.dirtymessaging.api.serialization.annotation;

import com.qualityplus.dirtymessaging.api.serialization.MessagePackSerializable;
import com.qualityplus.dirtymessaging.api.util.entry.EasyEntry;
import com.qualityplus.dirtymessaging.api.util.sneaky.SneakyBiConsumer;
import com.qualityplus.dirtymessaging.api.util.sneaky.SneakyFunction;
    ...
    default byte[] serialize() {
        try (MessageBufferPacker packer = MessagePack.newDefaultBufferPacker()) {
            for (Field field : this.getClass().getDeclaredFields()) {
                ...
                if (field.getAnnotation(DirtyField.class) == null) {
                    continue;
                }
